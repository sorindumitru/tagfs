...
\IEEEauthorblockA{Facultatea de Automatica\\si Calculatoare\\
...
The project implements a tag-based filesystem in Linux. It will contain
components for tagging files and browsing by tags.
\end{abstract}
