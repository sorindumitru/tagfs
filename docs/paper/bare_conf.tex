...
Email: catalina.macalet@cs.pub.ro}
\and
\IEEEauthorblockN{Eugen Hristev}
\IEEEauthorblockA{Computer Science Department\\
Politehnica University of Bucharest\\
Email: eugen.hristev@cs.pub.ro}
\and
\IEEEauthorblockN{Mihai Dinu}
\IEEEauthorblockA{Computer Science Department\\
Politehnica University of Bucharest\\
Email: mihai.dinu@cs.pub.ro}
\and
\IEEEauthorblockN{Sorin Dumitru}
\IEEEauthorblockA{Computer Science Department\\
Politehnica University of Bucharest\\
Email: sorin.dumitru@cs.pub.ro}}
...
\subsection{Ar trebui sa imi verifice cineva gramatica, exprimarea bla bla. }
In most operating systems the files are hierarchically organized. 
This means there usually is a starting point, or parent directory. 
In Windows based systems there are multiple starting points which are 
based on the physical hard drive partitions. In Unix flavours systems, 
there is a single root drive with different mount points available for users
to be able to add or remove subtrees from different drives, partitions, etc. 
...
Something about Neopomuk and existing kernel implementations for tag based filesystems.

\section{Tagfs}

A short description of how tagfs works.

\subsection{Storage}

\subsection{VFS Hooks}
