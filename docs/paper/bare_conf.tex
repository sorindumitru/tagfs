...
speciﬁc things. For example a getdenst call will list the ﬁles
associated with the provided tags.
...
\subsection{Unix-based commands} 
\todo{testare comenzi unix}


\subsection{TagFS commands} 
\todo{testare comenzi tagfs}
